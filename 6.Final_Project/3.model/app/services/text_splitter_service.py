...
class TextSplitterService:
    ...
    def create_child_splitter(self) -> RecursiveCharacterTextSplitter:
        """ADR-076: 부모 문서 리트리버용 자식 분할기(작은 청크) 생성.

        Returns:
            RecursiveCharacterTextSplitter with rag_child_chunk_size/overlap from settings.
        """
        settings = get_settings()
