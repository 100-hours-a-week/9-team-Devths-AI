...
def make_scan_image(image, width, ksize=(5, 5), min_threshold=75, max_threshold=200):
    """
    Note: This function references org_image which should be passed as the image parameter.
    The function resizes the input image and uses the original for transformation.
    """
    image_list_title = []
    image_list = []

    org_image = image.copy()  # Store original image before resizing
...
# The code below is commented out as it's unreachable (appears after return statement)
# This appears to be example/test code that should be moved to a separate test file
#
